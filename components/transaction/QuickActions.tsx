  ...
  return (
    <div className="flex flex-wrap gap-2" data-testid="quick-actions-expanded">
      ...
      <Button
        ...
        onClick={handleMarkNonNegotiable}
        data-testid="quick-action-non-negotiable"
        className={isNonNegotiable ? 'bg-gray-100 text-gray-700 border-gray-300 hover:bg-gray-200 hover:text-gray-800' : ''}
      >
        <svg
          className="w-4 h-4 mr-1.5"
          fill="none"
      ...
      <Button
        ...
        onClick={handleIgnore}
        data-testid="quick-action-ignore"
        className={isIgnored ? 'bg-gray-100 text-gray-700 border-gray-300 hover:bg-gray-200 hover:text-gray-800' : ''}
      >
        <svg
          className="w-4 h-4 mr-1.5"
          fill="none"
